...
class MlipCalc:
    ...
    def __init__(self, image_name, user_settings = None):
        ...
        self.dkskt = DockerSocket(self.image_name, self.dinput, self.dinput['start_port'], self.dinput['end_port'], self.dinput['init_timeout'], self.dinput['ncore'], self.dinput['mem'])
